...
Given an array of integers nums and a target integer target, write a Python function called subarray_sum that 
...
Note that there may be multiple subarrays that add up to the target sum, but your function only needs to return the 
